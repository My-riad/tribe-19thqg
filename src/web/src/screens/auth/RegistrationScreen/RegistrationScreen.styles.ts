...
// Main container for the registration screen with appropriate background color and padding
...
// Scrollable container for the registration screen content with keyboard handling
...
// Container for the registration form with appropriate padding and margin
...
// Styled text component for the footer link with appropriate typography and color
